...
function timely_scripts() {
	...
	wp_enqueue_script( 'timely-scroll', get_template_directory_uri() . '/js/scroll.js', array('jquery'), '', true );
	wp_enqueue_script( 'timely-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
