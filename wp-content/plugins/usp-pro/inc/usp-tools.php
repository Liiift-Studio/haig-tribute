...
function usp_tools_resources() {
	...
	$tools_resources .= '<li><a target="_blank" rel="noopener noreferrer" href="https://codex.wordpress.org/WordPress_Widgets">'. esc_html__('WP Widgets', 'usp-pro')               .'</a></li>';
	...
	$tools_resources .= '<li><a target="_blank" rel="noopener noreferrer" href="https://codex.wordpress.org/Post_Types">'.        esc_html__('WP Custom Post Types', 'usp-pro')     .'</a></li>';
	...
	$tools_resources .= '<li><a target="_blank" rel="noopener noreferrer" href="https://www.wordpress.org/support/">'.            esc_html__('WP Help Forum', 'usp-pro')            .'</a></li>';
	$tools_resources .= '</ul>';
...
function usp_tools_tips() {
	...
	$tools_tips .= '<dd>' . esc_html__('As explained in the ', 'usp-pro') . '<a target="_blank" rel="noopener noreferrer" href="https://codex.wordpress.org/Taxonomies#404_Error">'. esc_html__('WP Codex', 'usp-pro') .'</a>' . esc_html__(', an extra step is required to get WordPress to recognize theme templates for custom post types ', 'usp-pro');
