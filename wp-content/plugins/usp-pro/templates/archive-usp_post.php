<?php // USP Posts - Archive - Theme Template

/*
	This is a bare-bones template file that you can copy and paste into your theme
	When included, this file will enable display of the "usp_post" post type, archive views
	...
	To see it work, publish a few USP Posts, include this file, and visit @ https://example.com/usp_post/
*/
