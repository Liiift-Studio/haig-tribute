<?php // USP Forms - Archive - Theme Template

/*
	This is a bare-bones template file that you can copy and paste into your theme
	When included, this file will enable display of the "usp_form" post type, archive views
	...
	To see it work, publish a few USP Forms, include this file, and visit @ https://example.com/usp_form/
*/
